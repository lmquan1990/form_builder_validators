...
class FormBuilderLocalizationsImplEl extends FormBuilderLocalizationsImpl {
  ...
  @override
  String get phoneErrorText => 'Η τιμή πρέπει να είναι έγκυρος αριθμός τηλεφώνου.';

  @override
  String get creditCardExpirationDateErrorText => 'Η τιμή πρέπει να είναι έγκυρη ημερομηνία λήξης της πιστωτικής κάρτας.';

  @override
  String get creditCardExpiredErrorText => 'Η πιστωτική κάρτα έχει λήξει.';

  @override
  String get creditCardCVCErrorText => 'Η τιμή πρέπει να είναι έγκυρος κωδικός CVC της πιστωτικής κάρτας.';
  ...
  @override
  String get uppercaseErrorText => 'Η τιμή πρέπει να είναι με κεφαλαία γράμματα.';
  ...
  @override
  String get alphabeticalErrorText => 'Η τιμή πρέπει να περιέχει μόνο γράμματα.';
  ...
  @override
  String get latitudeErrorText => 'Η τιμή πρέπει να είναι έγκυρο γεωγραφικό πλάτος.';

  @override
  String get longitudeErrorText => 'Η τιμή πρέπει να είναι έγκυρο γεωγραφικό μήκος.';

  @override
  String get base64ErrorText => 'Η τιμή πρέπει να είναι έγκυρη ακολουθία Base64.';
  ...
  @override
  String get macAddressErrorText => 'Η τιμή πρέπει να είναι έγκυρη διεύθυνση MAC.';
  ...
  @override
  String get containsElementErrorText => 'Η τιμή πρέπει να είναι στη λίστα των επιτρεπόμενων τιμών.';
  ...
  @override
  String get dateMustBeInTheFutureErrorText => 'Η ημερομηνία πρέπει να είναι στο μέλλον.';

  @override
  String get dateMustBeInThePastErrorText => 'Η ημερομηνία πρέπει να είναι στο παρελθόν.';

  @override
  String get fileNameErrorText => 'Η τιμή πρέπει να είναι έγκυρο όνομα αρχείου.';

  @override
  String get negativeNumberErrorText => 'Η τιμή πρέπει να είναι αρνητικός αριθμός.';

  @override
  String get positiveNumberErrorText => 'Η τιμή πρέπει να είναι θετικός αριθμός.';

  @override
  String get notZeroNumberErrorText => 'Η τιμή δεν πρέπει να είναι μηδέν.';

  @override
  String get ssnErrorText => 'Η τιμή πρέπει να είναι έγκυρος Αριθμός Κοινωνικής Ασφάλισης.';

  @override
  String get zipCodeErrorText => 'Η τιμή πρέπει να είναι έγκυρος ταχυδρομικός κωδικός.';

  @override
  String get usernameErrorText => 'Η τιμή πρέπει να είναι ένα έγκυρο όνομα χρήστη.';

  @override
  String get usernameCannotContainNumbersErrorText => 'Το όνομα χρήστη δεν μπορεί να περιέχει αριθμούς.';

  @override
  String get usernameCannotContainUnderscoreErrorText => 'Το όνομα χρήστη δεν μπορεί να περιέχει κάτω παύλα.';

  @override
  String get usernameCannotContainSpecialCharErrorText => 'Το όνομα χρήστη δεν μπορεί να περιέχει ειδικούς χαρακτήρες.';

  @override
  String get usernameCannotContainSpacesErrorText => 'Το όνομα χρήστη δεν μπορεί να περιέχει κενά.';

  @override
  String get usernameCannotContainDotsErrorText => 'Το όνομα χρήστη δεν μπορεί να περιέχει τελείες.';

  @override
  String get usernameCannotContainDashesErrorText => 'Το όνομα χρήστη δεν μπορεί να περιέχει παύλες.';

  @override
  String get invalidMimeTypeErrorText => 'Μη έγκυρος τύπος MIME.';

  @override
  String get timezoneErrorText => 'Η τιμή πρέπει να είναι μια έγκυρη ζώνη ώρας.';
  ...
  @override
  String get passportNumberErrorText => 'Η τιμή πρέπει να είναι ένας έγκυρος αριθμός διαβατηρίου.';

  @override
  String get primeNumberErrorText => 'Η τιμή πρέπει να είναι ένας πρώτος αριθμός.';

  @override
  String get dunsErrorText => 'Η τιμή πρέπει να είναι ένας έγκυρος αριθμός DUNS.';

  @override
  String get licensePlateErrorText => 'Η τιμή πρέπει να είναι μια έγκυρη πινακίδα κυκλοφορίας.';

  @override
  String get vinErrorText => 'Η τιμή πρέπει να είναι ένας έγκυρος αριθμός VIN.';

  @override
  String get languageCodeErrorText => 'Η τιμή πρέπει να είναι ένας έγκυρος κωδικός γλώσσας.';
}
