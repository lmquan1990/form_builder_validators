...
class FormBuilderLocalizationsImplRo extends FormBuilderLocalizationsImpl {
  ...
  @override
  String get creditCardExpirationDateErrorText => 'Acest câmp necesită o dată de expirare a cardului de credit validă.';

  @override
  String get creditCardExpiredErrorText => 'Cardul de credit a expirat.';

  @override
  String get creditCardCVCErrorText => 'Acest câmp necesită un cod CVC valid al cardului de credit.';
  ...
  @override
  String get alphabeticalErrorText => 'Acest câmp trebuie să conțină doar litere.';
  ...
  @override
  String get containsElementErrorText => 'Valoarea trebuie să fie în lista valorilor permise.';
  ...
  @override
  String get singleLineErrorText => 'Acest câmp trebuie să fie pe o singură linie.';
  ...
  @override
  String get fileNameErrorText => 'Valoarea trebuie să fie un nume de fișier valid.';

  @override
  String get negativeNumberErrorText => 'Valoarea trebuie să fie un număr negativ.';

  @override
  String get positiveNumberErrorText => 'Valoarea trebuie să fie un număr pozitiv.';

  @override
  String get notZeroNumberErrorText => 'Valoarea nu trebuie să fie zero.';

  @override
  String get ssnErrorText => 'Valoarea trebuie să fie un Număr de Asigurare Socială valid.';

  @override
  String get zipCodeErrorText => 'Valoarea trebuie să fie un cod ZIP valid.';

  @override
  String get usernameErrorText => 'Valoarea trebuie să fie un nume de utilizator valid.';

  @override
  String get usernameCannotContainNumbersErrorText => 'Numele de utilizator nu poate conţine cifre.';

  @override
  String get usernameCannotContainUnderscoreErrorText => 'Numele de utilizator nu poate conţine caractere de subliniere.';

  @override
  String get usernameCannotContainSpecialCharErrorText => 'Numele de utilizator nu poate conţine caractere speciale.';

  @override
  String get usernameCannotContainSpacesErrorText => 'Numele de utilizator nu poate conţine spaţii.';

  @override
  String get usernameCannotContainDotsErrorText => 'Numele de utilizator nu poate conţine puncte.';

  @override
  String get usernameCannotContainDashesErrorText => 'Numele de utilizator nu poate conţine cratime.';
  ...
  @override
  String get streetErrorText => 'Valoarea trebuie să fie un nume de stradă valid.';

  @override
  String get firstNameErrorText => 'Valoarea trebuie să fie un prenume valid.';

  @override
  String get lastNameErrorText => 'Valoarea trebuie să fie un nume de familie valid.';

  @override
  String get passportNumberErrorText => 'Valoarea trebuie să fie un număr de pașaport valid.';
  ...
  @override
  String get licensePlateErrorText => 'Valoarea trebuie să fie un număr de înmatriculare valid.';

  @override
  String get vinErrorText => 'Valoarea trebuie să fie un VIN valid.';

  @override
  String get languageCodeErrorText => 'Valoarea trebuie să fie un cod de limbă valid.';
}
