...
class FormBuilderLocalizationsImplPt extends FormBuilderLocalizationsImpl {
  ...
  @override
  String get phoneErrorText => 'Este campo requer um número de telefone válido.';

  @override
  String get creditCardExpirationDateErrorText => 'Este campo requer uma data de validade do cartão de crédito válida.';

  @override
  String get creditCardExpiredErrorText => 'O cartão de crédito está expirado.';

  @override
  String get creditCardCVCErrorText => 'Este campo requer um código CVC do cartão de crédito válido.';
  ...
  @override
  String get containsElementErrorText => 'O valor deve estar na lista de valores permitidos.';
  ...
  @override
  String get ssnErrorText => 'O valor deve ser um Número de Seguro Social válido.';
  ...
  @override
  String get usernameCannotContainNumbersErrorText => 'O nome de usuário não pode conter números.';

  @override
  String get usernameCannotContainUnderscoreErrorText => 'O nome de usuário não pode conter sublinhados.';

  @override
  String get usernameCannotContainSpecialCharErrorText => 'O nome de usuário não pode conter caracteres especiais.';

  @override
  String get usernameCannotContainSpacesErrorText => 'O nome de usuário não pode conter espaços.';

  @override
  String get usernameCannotContainDotsErrorText => 'O nome de usuário não pode conter pontos.';

  @override
  String get usernameCannotContainDashesErrorText => 'O nome de usuário não pode conter traços.';
  ...
  @override
  String get passportNumberErrorText => 'O valor deve ser um número de passaporte válido.';
  ...
  @override
  String get licensePlateErrorText => 'O valor deve ser uma placa de licença válida.';

  @override
  String get vinErrorText => 'O valor deve ser um VIN válido.';

  @override
  String get languageCodeErrorText => 'O valor deve ser um código de idioma válido.';
}
