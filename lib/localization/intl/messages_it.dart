...
class FormBuilderLocalizationsImplIt extends FormBuilderLocalizationsImpl {
  ...
  @override
  String get phoneErrorText => 'Questo campo richiede un numero di telefono valido.';

  @override
  String get creditCardExpirationDateErrorText => 'Questo campo richiede una data di scadenza della carta di credito valida.';

  @override
  String get creditCardExpiredErrorText => 'La carta di credito è scaduta.';

  @override
  String get creditCardCVCErrorText => 'Questo campo richiede un codice CVC della carta di credito valido.';
  ...
  @override
  String get alphabeticalErrorText => 'Questo campo deve contenere solo lettere.';
  ...
  @override
  String get latitudeErrorText => 'Questo campo richiede una latitudine valida.';

  @override
  String get longitudeErrorText => 'Questo campo richiede una longitudine valida.';

  @override
  String get base64ErrorText => 'Questo campo richiede una stringa Base64 valida.';
  ...
  @override
  String get macAddressErrorText => 'Questo campo richiede un indirizzo MAC valido.';
  ...
  @override
  String get containsElementErrorText => 'Il valore deve essere presente nell\'elenco dei valori consentiti.';
  ...
  @override
  String get singleLineErrorText => 'Questo campo richiede un testo su una sola riga.';

  @override
  String get timeErrorText => 'Questo campo richiede un orario valido.';

  @override
  String get dateMustBeInTheFutureErrorText => 'La data deve essere nel futuro.';
  ...
  @override
  String get negativeNumberErrorText => 'Il valore deve essere un numero negativo.';

  @override
  String get positiveNumberErrorText => 'Il valore deve essere un numero positivo.';

  @override
  String get notZeroNumberErrorText => 'Il valore non deve essere zero.';

  @override
  String get ssnErrorText => 'Il valore deve essere un numero di previdenza sociale valido.';

  @override
  String get zipCodeErrorText => 'Il valore deve essere un codice postale valido.';

  @override
  String get usernameErrorText => 'Il valore deve essere un nome utente valido.';

  @override
  String get usernameCannotContainNumbersErrorText => 'Il nome utente non può contenere numeri.';

  @override
  String get usernameCannotContainUnderscoreErrorText => 'Il nome utente non può contenere underscore.';

  @override
  String get usernameCannotContainSpecialCharErrorText => 'Il nome utente non può contenere caratteri speciali.';

  @override
  String get usernameCannotContainSpacesErrorText => 'Il nome utente non può contenere spazi.';

  @override
  String get usernameCannotContainDotsErrorText => 'Il nome utente non può contenere punti.';

  @override
  String get usernameCannotContainDashesErrorText => 'Il nome utente non può contenere trattini.';

  @override
  String get invalidMimeTypeErrorText => 'Tipo mime non valido.';

  @override
  String get timezoneErrorText => 'Il valore deve essere un fuso orario valido.';
  ...
  @override
  String get passportNumberErrorText => 'Il valore deve essere un numero di passaporto valido.';
  ...
  @override
  String get languageCodeErrorText => 'Il valore deve essere un codice lingua valido.';
}
