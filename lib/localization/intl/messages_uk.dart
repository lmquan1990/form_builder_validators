...
class FormBuilderLocalizationsImplUk extends FormBuilderLocalizationsImpl {
  ...
  @override
  String get creditCardExpirationDateErrorText => 'Поле має бути дійсною датою закінчення терміну дії кредитної картки.';

  @override
  String get creditCardExpiredErrorText => 'Термін дії кредитної картки закінчився.';

  @override
  String get creditCardCVCErrorText => 'Поле має бути дійсним CVC кодом кредитної картки.';
  ...
  @override
  String get containsElementErrorText => 'Значення має бути в списку дозволених значень.';
  ...
  @override
  String get dateMustBeInTheFutureErrorText => 'Дата повинна бути у майбутньому.';
  ...
  @override
  String get negativeNumberErrorText => 'Значення повинно бути від\'ємним числом.';

  @override
  String get positiveNumberErrorText => 'Значення повинно бути позитивним числом.';

  @override
  String get notZeroNumberErrorText => 'Значення не повинно бути нулем.';

  @override
  String get ssnErrorText => 'Значення повинно бути дійсним номером соціального страхування.';

  @override
  String get zipCodeErrorText => 'Значення повинно бути дійсним поштовим індексом.';

  @override
  String get usernameErrorText => 'Значення має бути дійсним ім\'ям користувача.';

  @override
  String get usernameCannotContainNumbersErrorText => 'Ім\'я користувача не може містити цифри.';

  @override
  String get usernameCannotContainUnderscoreErrorText => 'Ім\'я користувача не може містити символ підкреслення.';

  @override
  String get usernameCannotContainSpecialCharErrorText => 'Ім\'я користувача не може містити спеціальні символи.';

  @override
  String get usernameCannotContainSpacesErrorText => 'Ім\'я користувача не може містити пробіли.';

  @override
  String get usernameCannotContainDotsErrorText => 'Ім\'я користувача не може містити крапки.';

  @override
  String get usernameCannotContainDashesErrorText => 'Ім\'я користувача не може містити дефіси.';

  @override
  String get invalidMimeTypeErrorText => 'Недійсний MIME тип.';

  @override
  String get timezoneErrorText => 'Значення повинно бути дійсним часовим поясом.';
  ...
  @override
  String get passportNumberErrorText => 'Значення повинно бути дійсним номером паспорта.';
  ...
  @override
  String get licensePlateErrorText => 'Значення повинно бути дійсним номерним знаком автомобіля.';

  @override
  String get vinErrorText => 'Значення повинно бути дійсним VIN.';

  @override
  String get languageCodeErrorText => 'Значення повинно бути дійсним кодом мови.';
}
