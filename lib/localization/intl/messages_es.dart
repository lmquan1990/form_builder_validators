...
class FormBuilderLocalizationsImplEs extends FormBuilderLocalizationsImpl {
  ...
  @override
  String get phoneErrorText => 'Este campo requiere un número de teléfono válido.';

  @override
  String get creditCardExpirationDateErrorText => 'Este campo requiere una fecha de vencimiento válida para la tarjeta de crédito.';

  @override
  String get creditCardExpiredErrorText => 'La tarjeta de crédito ha expirado.';

  @override
  String get creditCardCVCErrorText => 'Este campo requiere un código CVC válido para la tarjeta de crédito.';
  ...
  @override
  String get macAddressErrorText => 'Este campo requiere una dirección MAC válida.';
  ...
  @override
  String get containsElementErrorText => 'El valor debe estar en la lista de valores permitidos.';
  ...
  @override
  String get singleLineErrorText => 'Este campo debe contener una sola línea de texto.';

  @override
  String get timeErrorText => 'Este campo requiere una hora válida.';

  @override
  String get dateMustBeInTheFutureErrorText => 'La fecha debe estar en el futuro.';

  @override
  String get dateMustBeInThePastErrorText => 'La fecha debe estar en el pasado.';

  @override
  String get fileNameErrorText => 'El valor debe ser un nombre de archivo válido.';
  ...
  @override
  String get ssnErrorText => 'El valor debe ser un número de Seguro Social válido.';

  @override
  String get zipCodeErrorText => 'El valor debe ser un código ZIP válido.';

  @override
  String get usernameErrorText => 'El valor debe ser un nombre de usuario válido.';

  @override
  String get usernameCannotContainNumbersErrorText => 'El nombre de usuario no puede contener números.';

  @override
  String get usernameCannotContainUnderscoreErrorText => 'El nombre de usuario no puede contener guiones bajos.';

  @override
  String get usernameCannotContainSpecialCharErrorText => 'El nombre de usuario no puede contener caracteres especiales.';

  @override
  String get usernameCannotContainSpacesErrorText => 'El nombre de usuario no puede contener espacios.';

  @override
  String get usernameCannotContainDotsErrorText => 'El nombre de usuario no puede contener puntos.';

  @override
  String get usernameCannotContainDashesErrorText => 'El nombre de usuario no puede contener guiones.';
  ...
  @override
  String get passportNumberErrorText => 'El valor debe ser un número de pasaporte válido.';
  ...
  @override
  String get licensePlateErrorText => 'El valor debe ser una placa de matrícula válida.';

  @override
  String get vinErrorText => 'El valor debe ser un VIN válido.';

  @override
  String get languageCodeErrorText => 'El valor debe ser un código de idioma válido.';
}
