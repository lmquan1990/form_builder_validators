...
class FormBuilderLocalizationsImplSq extends FormBuilderLocalizationsImpl {
  ...
  @override
  String get creditCardErrorText => 'Kjo fushë kërkon një numër të vlefshëm për kartën e kreditit.';

  @override
  String get dateStringErrorText => 'Kjo fushë kërkon një datë të vlefshme.';

  @override
  String get emailErrorText => 'Kjo fushë kërkon një adresë e E-mail-i të vlefshme.';
  ...
  @override
  String get integerErrorText => 'Kjo fushë kërkon një numër të plotë të vlefshëm.';
  ...
  @override
  String get phoneErrorText => 'Kjo fushë kërkon një numër telefoni të vlefshëm.';

  @override
  String get creditCardExpirationDateErrorText => 'Kjo fushë kërkon një datë skadence të vlefshme për kartën e kreditit.';

  @override
  String get creditCardExpiredErrorText => 'Karta e kreditit ka skaduar.';

  @override
  String get creditCardCVCErrorText => 'Kjo fushë kërkon një kod CVC të vlefshëm për kartën e kreditit.';
  ...
  @override
  String get alphabeticalErrorText => 'Kjo fushë duhet të përmbajë vetëm shkronja alfabetike.';
  ...
  @override
  String get latitudeErrorText => 'Kjo fushë kërkon një gjerësi gjeografike të vlefshme.';

  @override
  String get longitudeErrorText => 'Kjo fushë kërkon një gjatësi gjeografike të vlefshme.';

  @override
  String get base64ErrorText => 'Kjo fushë kërkon një string Base64 të vlefshëm.';
  ...
  @override
  String get macAddressErrorText => 'Kjo fushë kërkon një adresë MAC të vlefshme.';
  ...
  @override
  String get containsElementErrorText => 'Vlera duhet të jetë në listën e vlefshme.';
  ...
  @override
  String get dateMustBeInTheFutureErrorText => 'Data duhet të jetë në të ardhmen.';

  @override
  String get dateMustBeInThePastErrorText => 'Data duhet të jetë në të kaluarën.';

  @override
  String get fileNameErrorText => 'Vlera duhet të jetë një emër skedari i vlefshëm.';

  @override
  String get negativeNumberErrorText => 'Vlera duhet të jetë një numër negativ.';

  @override
  String get positiveNumberErrorText => 'Vlera duhet të jetë një numër pozitiv.';

  @override
  String get notZeroNumberErrorText => 'Vlera nuk duhet të jetë zero.';

  @override
  String get ssnErrorText => 'Vlera duhet të jetë një numër Social Security i vlefshëm.';

  @override
  String get zipCodeErrorText => 'Vlera duhet të jetë një kod ZIP i vlefshëm.';

  @override
  String get usernameErrorText => 'Vlera duhet të jetë një emër përdoruesi i vlefshëm.';

  @override
  String get usernameCannotContainNumbersErrorText => 'Emri i përdoruesit nuk mund të përmbajë numra.';

  @override
  String get usernameCannotContainUnderscoreErrorText => 'Emri i përdoruesit nuk mund të përmbajë vijë të poshtme.';

  @override
  String get usernameCannotContainSpecialCharErrorText => 'Emri i përdoruesit nuk mund të përmbajë karaktere speciale.';

  @override
  String get usernameCannotContainSpacesErrorText => 'Emri i përdoruesit nuk mund të përmbajë hapësira.';

  @override
  String get usernameCannotContainDotsErrorText => 'Emri i përdoruesit nuk mund të përmbajë pika.';

  @override
  String get usernameCannotContainDashesErrorText => 'Emri i përdoruesit nuk mund të përmbajë vija.';

  @override
  String get invalidMimeTypeErrorText => 'Lloji mime i pavlefshëm.';

  @override
  String get timezoneErrorText => 'Vlera duhet të jetë një zonë kohore e vlefshme.';
  ...
  @override
  String get streetErrorText => 'Vlera duhet të jetë një emër rrugë e vlefshme.';

  @override
  String get firstNameErrorText => 'Vlera duhet të jetë një emër i parë i vlefshëm.';

  @override
  String get lastNameErrorText => 'Vlera duhet të jetë një mbiemër i vlefshëm.';

  @override
  String get passportNumberErrorText => 'Vlera duhet të jetë një numër pasaporte i vlefshëm.';

  @override
  String get primeNumberErrorText => 'Vlera duhet të jetë një numër kryesor i vlefshëm.';

  @override
  String get dunsErrorText => 'Vlera duhet të jetë një numër DUNS i vlefshëm.';

  @override
  String get licensePlateErrorText => 'Vlera duhet të jetë një targë makine e vlefshme.';

  @override
  String get vinErrorText => 'Vlera duhet të jetë një VIN i vlefshëm.';

  @override
  String get languageCodeErrorText => 'Vlera duhet të jetë një kod gjuhe i vlefshëm.';
}
