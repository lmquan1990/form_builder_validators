...
class FormBuilderLocalizationsImplJa extends FormBuilderLocalizationsImpl {
  ...
  @override
  String get usernameCannotContainUnderscoreErrorText => 'ユーザー名にアンダースコアを含めることはできません。';

  @override
  String get usernameCannotContainSpecialCharErrorText => 'ユーザー名に特殊文字を含めることはできません。';
