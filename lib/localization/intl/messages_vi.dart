...
class FormBuilderLocalizationsImplVi extends FormBuilderLocalizationsImpl {
  ...
  @override
  String get creditCardExpirationDateErrorText => 'Yêu cầu nhập đúng ngày hết hạn của thẻ tín dụng.';

  @override
  String get creditCardExpiredErrorText => 'Thẻ tín dụng đã hết hạn.';

  @override
  String get creditCardCVCErrorText => 'Yêu cầu nhập đúng mã CVC của thẻ tín dụng.';
  ...
  @override
  String get containsElementErrorText => 'Giá trị phải nằm trong danh sách các giá trị hợp lệ.';
  ...
  @override
  String get usernameCannotContainNumbersErrorText => 'Tên người dùng không được chứa số.';

  @override
  String get usernameCannotContainUnderscoreErrorText => 'Tên người dùng không được chứa dấu gạch dưới.';

  @override
  String get usernameCannotContainSpecialCharErrorText => 'Tên người dùng không được chứa ký tự đặc biệt.';

  @override
  String get usernameCannotContainSpacesErrorText => 'Tên người dùng không được chứa khoảng trắng.';

  @override
  String get usernameCannotContainDotsErrorText => 'Tên người dùng không được chứa dấu chấm.';

  @override
  String get usernameCannotContainDashesErrorText => 'Tên người dùng không được chứa dấu gạch ngang.';
