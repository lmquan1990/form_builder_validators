...
class FormBuilderLocalizationsImplFr extends FormBuilderLocalizationsImpl {
  ...
  @override
  String get phoneErrorText => 'Ce champ nécessite un numéro de téléphone valide.';

  @override
  String get creditCardExpirationDateErrorText => 'Ce champ nécessite une date d\'expiration valide pour la carte de crédit.';

  @override
  String get creditCardExpiredErrorText => 'La carte de crédit a expiré.';

  @override
  String get creditCardCVCErrorText => 'Ce champ nécessite un code CVC valide pour la carte de crédit.';
  ...
  @override
  String get alphabeticalErrorText => 'Ce champ doit contenir uniquement des lettres.';
  ...
  @override
  String get macAddressErrorText => 'Ce champ nécessite une adresse MAC valide.';
  ...
  @override
  String get containsElementErrorText => 'La valeur doit être dans la liste des valeurs autorisées.';
  ...
  @override
  String get dateMustBeInTheFutureErrorText => 'La date doit être dans le futur.';

  @override
  String get dateMustBeInThePastErrorText => 'La date doit être dans le passé.';

  @override
  String get fileNameErrorText => 'La valeur doit être un nom de fichier valide.';

  @override
  String get negativeNumberErrorText => 'La valeur doit être un nombre négatif.';

  @override
  String get positiveNumberErrorText => 'La valeur doit être un nombre positif.';

  @override
  String get notZeroNumberErrorText => 'La valeur ne doit pas être zéro.';

  @override
  String get ssnErrorText => 'La valeur doit être un numéro de sécurité sociale valide.';

  @override
  String get zipCodeErrorText => 'La valeur doit être un code postal valide.';

  @override
  String get usernameErrorText => 'La valeur doit être un nom d\'utilisateur valide.';

  @override
  String get usernameCannotContainNumbersErrorText => 'Le nom d\'utilisateur ne peut pas contenir de chiffres.';

  @override
  String get usernameCannotContainUnderscoreErrorText => 'Le nom d\'utilisateur ne peut pas contenir de tiret bas.';

  @override
  String get usernameCannotContainSpecialCharErrorText => 'Le nom d\'utilisateur ne peut pas contenir de caractères spéciaux.';

  @override
  String get usernameCannotContainSpacesErrorText => 'Le nom d\'utilisateur ne peut pas contenir d\'espaces.';

  @override
  String get usernameCannotContainDotsErrorText => 'Le nom d\'utilisateur ne peut pas contenir de points.';

  @override
  String get usernameCannotContainDashesErrorText => 'Le nom d\'utilisateur ne peut pas contenir de tirets.';

  @override
  String get invalidMimeTypeErrorText => 'Type MIME invalide.';

  @override
  String get timezoneErrorText => 'La valeur doit être un fuseau horaire valide.';
  ...
  @override
  String get lastNameErrorText => 'La valeur doit être un nom de famille valide.';

  @override
  String get passportNumberErrorText => 'La valeur doit être un numéro de passeport valide.';
  ...
  @override
  String get licensePlateErrorText => 'La valeur doit être une plaque d\'immatriculation valide.';

  @override
  String get vinErrorText => 'La valeur doit être un numéro VIN valide.';

  @override
  String get languageCodeErrorText => 'La valeur doit être un code de langue valide.';
}
