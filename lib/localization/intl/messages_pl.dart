...
class FormBuilderLocalizationsImplPl extends FormBuilderLocalizationsImpl {
  ...
  @override
  String get creditCardExpirationDateErrorText => 'To pole wymaga prawidłowej daty ważności karty kredytowej.';

  @override
  String get creditCardExpiredErrorText => 'Karta kredytowa straciła ważność.';

  @override
  String get creditCardCVCErrorText => 'To pole wymaga prawidłowego kodu CVC karty kredytowej.';
  ...
  @override
  String get latitudeErrorText => 'To pole wymaga prawidłowej szerokości geograficznej.';

  @override
  String get longitudeErrorText => 'To pole wymaga prawidłowej długości geograficznej.';
  ...
  @override
  String get containsElementErrorText => 'Wartość musi być na liście dozwolonych wartości.';
  ...
  @override
  String get ssnErrorText => 'Wartość musi być prawidłowym numerem ubezpieczenia społecznego.';

  @override
  String get zipCodeErrorText => 'Wartość musi być prawidłowym kodem pocztowym.';

  @override
  String get usernameErrorText => 'Wartość musi być prawidłową nazwą użytkownika.';

  @override
  String get usernameCannotContainNumbersErrorText => 'Nazwa użytkownika nie może zawierać cyfr.';

  @override
  String get usernameCannotContainUnderscoreErrorText => 'Nazwa użytkownika nie może zawierać podkreślenia.';

  @override
  String get usernameCannotContainSpecialCharErrorText => 'Nazwa użytkownika nie może zawierać znaków specjalnych.';

  @override
  String get usernameCannotContainSpacesErrorText => 'Nazwa użytkownika nie może zawierać spacji.';

  @override
  String get usernameCannotContainDotsErrorText => 'Nazwa użytkownika nie może zawierać kropek.';

  @override
  String get usernameCannotContainDashesErrorText => 'Nazwa użytkownika nie może zawierać myślników.';
  ...
  @override
  String get passportNumberErrorText => 'Wartość musi być prawidłowym numerem paszportu.';
  ...
  @override
  String get licensePlateErrorText => 'Wartość musi być prawidłowym numerem tablicy rejestracyjnej.';

  @override
  String get vinErrorText => 'Wartość musi być prawidłowym numerem VIN.';

  @override
  String get languageCodeErrorText => 'Wartość musi być prawidłowym kodem języka.';
}
