...
class FormBuilderLocalizationsImplTa extends FormBuilderLocalizationsImpl {
  ...
  @override
  String get creditCardExpirationDateErrorText => 'இந்த உள்ளீட்டுக்கு சரியான கிரெடிட் கார்டு காலாவதி தேதியை தேவை.';

  @override
  String get creditCardExpiredErrorText => 'கிரெடிட் கார்டு காலாவதி செய்யப்பட்டுள்ளது.';

  @override
  String get creditCardCVCErrorText => 'இந்த உள்ளீட்டுக்கு சரியான கிரெடிட் கார்டு CVC குறியீடு தேவை.';
  ...
  @override
  String get uppercaseErrorText => 'இந்த உள்ளீடு பெரிய எழுத்துகளை கொண்டிருக்க வேண்டும்.';

  @override
  String get lowercaseErrorText => 'இந்த உள்ளீடு சிறிய எழுத்துகளை கொண்டிருக்க வேண்டும்.';
  ...
  @override
  String get alphabeticalErrorText => 'இந்த உள்ளீடு எழுத்துக்களை மட்டுமே கொண்டிருக்க வேண்டும்.';
  ...
  @override
  String get macAddressErrorText => 'இந்த உள்ளீட்டுக்கு சரியான MAC முகவரி தேவை.';
  ...
  @override
  String get containsElementErrorText => 'மதிப்பு அனுமதிக்கப்பட்ட மதிப்புகளின் பட்டியலில் இருக்க வேண்டும்.';

  @override
  String get ibanErrorText => 'இந்த உள்ளீட்டுக்கு சரியான ஐபான் தேவை.';

  @override
  String get uniqueErrorText => 'இந்த உள்ளீடு அதிகமான மதிப்புகளை கொண்டிருக்க வேண்டும்.';
  ...
  @override
  String get singleLineErrorText => 'இந்த உள்ளீட்டு ஒரு வரிசையாக இருக்க வேண்டும்.';

  @override
  String get timeErrorText => 'இந்த உள்ளீட்டுக்கு சரியான நேரம் தேவை.';

  @override
  String get dateMustBeInTheFutureErrorText => 'தேதி எதிர்காலத்தில் இருக்க வேண்டும்.';

  @override
  String get dateMustBeInThePastErrorText => 'தேதி கடந்த காலத்தில் இருக்க வேண்டும்.';

  @override
  String get fileNameErrorText => 'மதிப்பை சரியான கோப்பு பெயராக இருக்க வேண்டும்.';
  ...
  @override
  String get zipCodeErrorText => 'மதிப்பு சரியான ஜிப் குறியீடு இருக்க வேண்டும்.';

  @override
  String get usernameErrorText => 'விலைமை சரியான பயனர் பெயராக இருக்க வேண்டும்.';

  @override
  String get usernameCannotContainNumbersErrorText => 'பயனர் பெயரில் எண்கள் இருக்கக் கூடாது.';

  @override
  String get usernameCannotContainUnderscoreErrorText => 'பயனர் பெயரில் அடிக்கோடு இருக்கக் கூடாது.';

  @override
  String get usernameCannotContainSpecialCharErrorText => 'பயனர் பெயரில் சிறப்பு எழுத்துக்கள் இருக்கக் கூடாது.';

  @override
  String get usernameCannotContainSpacesErrorText => 'பயனர் பெயரில் இடைவெளிகள் இருக்கக் கூடாது.';

  @override
  String get usernameCannotContainDotsErrorText => 'பயனர் பெயரில் புள்ளிகள் இருக்கக் கூடாது.';

  @override
  String get usernameCannotContainDashesErrorText => 'பயனர் பெயரில் கோடுகள் இருக்கக் கூடாது.';

  @override
  String get invalidMimeTypeErrorText => 'செல்லுபடியாகாத மைம் வகை.';

  @override
  String get timezoneErrorText => 'மதிப்பு ஒரு செல்லுபடியான நேரம் மண்டலம் ஆக வேண்டும்.';

  @override
  String get cityErrorText => 'மதிப்பு ஒரு செல்லுபடியான நகரத்தின் பெயராக இருக்க வேண்டும்.';

  @override
  String get countryErrorText => 'மதிப்பு ஒரு செல்லுபடியான நாட்டாக இருக்க வேண்டும்.';

  @override
  String get stateErrorText => 'மதிப்பு ஒரு செல்லுபடியான மாநிலமாக இருக்க வேண்டும்.';

  @override
  String get streetErrorText => 'மதிப்பு ஒரு செல்லுபடியான தெருப்பெயராக இருக்க வேண்டும்.';

  @override
  String get firstNameErrorText => 'மதிப்பு ஒரு செல்லுபடியான முதல் பெயராக இருக்க வேண்டும்.';

  @override
  String get lastNameErrorText => 'மதிப்பு ஒரு செல்லுபடியான இறுதி பெயராக இருக்க வேண்டும்.';

  @override
  String get passportNumberErrorText => 'மதிப்பு ஒரு செல்லுபடியான பாஸ்போர்ட் எணாக இருக்க வேண்டும்.';

  @override
  String get primeNumberErrorText => 'மதிப்பு ஒரு பகോ எணாக இருக்க வேண்டும்.';

  @override
  String get dunsErrorText => 'மதிப்பு ஒரு செல்லுபடியான DUNS எணாக இருக்க வேண்டும்.';

  @override
  String get licensePlateErrorText => 'மதிப்பு ஒரு செல்லுபடியான பதிவு தகடு (license plate) எணாக இருக்க வேண்டும்.';

  @override
  String get vinErrorText => 'மதிப்பு ஒரு செல்லுபடியான வாகன அடையாள எணாக (VIN) இருக்க வேண்டும்.';

  @override
  String get languageCodeErrorText => 'மதிப்பு ஒரு செல்லுபடியான மொழி குறியீடாக இருக்க வேண்டும்.';
}
