...
class FormBuilderLocalizationsImplMn extends FormBuilderLocalizationsImpl {
  ...
  @override
  String get creditCardExpirationDateErrorText => 'Кредит картын хүчинтэй хугацааг оруулна уу.';

  @override
  String get creditCardExpiredErrorText => 'Кредит картын хүчинтэй хугацаа дууссан байна.';
  ...
  @override
  String get containsElementErrorText => 'Утга нь зөвшөөрөгдсөн утгуудын жагсаалтад байх ёстой.';
  ...
  @override
  String get usernameErrorText => 'Утга нь хүчин төгөлдөр хэрэглэгчийн нэр байх ёстой.';

  @override
  String get usernameCannotContainNumbersErrorText => 'Хэрэглэгчийн нэр тоо агуулж болохгүй.';

  @override
  String get usernameCannotContainUnderscoreErrorText => 'Хэрэглэгчийн нэр доогуур зураас агуулж болохгүй.';

  @override
  String get usernameCannotContainSpecialCharErrorText => 'Хэрэглэгчийн нэр тусгай тэмдэгт агуулж болохгүй.';

  @override
  String get usernameCannotContainSpacesErrorText => 'Хэрэглэгчийн нэр хоосон зай агуулж болохгүй.';

  @override
  String get usernameCannotContainDotsErrorText => 'Хэрэглэгчийн нэр цэг агуулж болохгүй.';

  @override
  String get usernameCannotContainDashesErrorText => 'Хэрэглэгчийн нэр зураас агуулж болохгүй.';

  @override
  String get invalidMimeTypeErrorText => 'Буруу mime төрөл.';

  @override
  String get timezoneErrorText => 'Утга нь хүчин төгөлдөр цагийн бүс байх ёстой.';
  ...
  @override
  String get streetErrorText => 'Утга нь хүчин төгөлдөр гудамжны нэр байх ёстой.';

  @override
  String get firstNameErrorText => 'Утга нь хүчин төгөлдөр анхны нэр байх ёстой.';

  @override
  String get lastNameErrorText => 'Утга нь хүчин төгөлдөр овог байх ёстой.';

  @override
  String get passportNumberErrorText => 'Утга нь хүчин төгөлдөр паспортын дугаар байх ёстой.';
  ...
  @override
  String get licensePlateErrorText => 'Утга нь хүчин төгөлдөр тээврийн хэрэгслийн дугаар байх ёстой.';

  @override
  String get vinErrorText => 'Утга нь хүчин төгөлдөр VIN байх ёстой.';

  @override
  String get languageCodeErrorText => 'Утга нь хүчин төгөлдөр хэлний код байх ёстой.';
}
